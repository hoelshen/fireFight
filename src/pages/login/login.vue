  ...
  <div class="appDiv flex column">
    <div class="flex column j-between">
      ...
      <div class="loginDiv">
        ...
        <div
          class="tex-center"
          style="font-size: 20rpx;padding: 20rpx 0;"
        >
          此小程序仅为企业内部员工使用，请凭客户帐号密码登录
        </div>
      ...
      this.$request
        ...
        .then(res => {
          if(res.state == 0) {
            ...
            wx.reLaunch({
              url: `/pages/index/index?userTitle=${this.userTitle}`
            });
          } else {
              wx.showToast({
                title: res.message,
...
.loginDiv{
  z-index:2;
  background:url(data:image/png;base64,);
