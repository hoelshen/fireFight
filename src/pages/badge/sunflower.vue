<template>
  <view class="ticket flex column j-between">
    <div>
      <p class="title">Hey,Tellers</p>
      <p class="content">来看另一枚特殊的徽章：向日葵</p>
      ...
      <p
        class="content"
      >你需要发自内心喜爱 Tell 这个社区，同时能够真正在「帮助他人」这件事上获取到喜悦和满足。你每天或许要面对更多来自别人的烦恼，因此，你需要一定的乐观精神，并且每天保有一定的时间来解答咨询。</p>
      <p class="content">同时我们也希望你能够配合 Tell ，对外宣发关于 Tell 相关的活动信息。在 Tell 的用户微信群里，引导新加入的成员，帮助解决群员提出的问题。</p>
      <p class="content">目前，向日葵徽章采取邀请制和申请制。Tell 团队会在某些情况下直接向优秀的解答者赠予徽章，若不想等待，可在下方主动申请。</p>
      <div class="content">
